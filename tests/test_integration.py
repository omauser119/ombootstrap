...
from ombootstrap.config.state import config, CONFIG_DEFAULTS
from ombootstrap.constants import SRCINFO_METADATA_FILE
...
from ombootstrap.packages.cli import (
    SRCINFO_CACHE_FILES,
    cmd_build,
    cmd_clean,
    cmd_init,
...
from ombootstrap.utils import git_get_branch
...
def ctx() -> click.Context:
    ...
    config_path = os.path.join(tempdir, "ombootstrap.toml")
...
def test_main_import():
    from ombootstrap.main import cli
