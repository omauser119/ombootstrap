...
from ombootstrap.config.state import ConfigStateHolder, config
from ombootstrap.devices.device import (
    Device,
    DEVICE_DEPRECATIONS,
    get_device,
    get_devices,
    parse_device_pkg,
    check_devicepkg_name,
)
...
def test_fixture_initialise_pkgbuilds_dir(
    initialise_pkgbuilds_dir: ConfigStateHolder,
):
